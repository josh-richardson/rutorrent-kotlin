...
fun main(args: Array<String>) {
    ...
    val gson = Gson()
    var details : ArrayList<String>? = gson.fromJson(Scanner(File("src/com/eagles13/rut_downloader/credentials.txt")).useDelimiter("\\Z").next(), object : TypeToken<ArrayList<String>>(){}.type)
